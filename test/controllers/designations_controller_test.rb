...
class DesignationsControllerTest < ActionController::TestCase
  ...
  test "should create designation" do
    assert_difference('Designation.count') do
      post :create, designation: { course_duration: @designation.course_duration, for_search_id: @designation.for_search_id, name: @designation.name }
    end
  ...
  test "should update designation" do
    patch :update, id: @designation, designation: { course_duration: @designation.course_duration, for_search_id: @designation.for_search_id, name: @designation.name }
    assert_redirected_to designation_path(assigns(:designation))
  end
